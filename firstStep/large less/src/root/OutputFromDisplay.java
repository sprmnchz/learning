...
public class OutputFromDisplay {
    ...
    public void outputTheInstruction(){System.out.println("Вам нужно угадать число за меньшее число попыток. После ввода будет выдан результат. Верный ли ответ или насколько выблизззко");}
